...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    // Thêm sản phẩm
    $db_util->execute("INSERT INTO nguoidung (ten, email, soDienThoai, diaChi, ngayTao) VALUES (?, ?, ?, ?, ?)", [$ten, $email, $sdt, $diachi, $ngaytao]);
...
<body>
    ...
    <div class="form-container">
        ...
        <form method="post" action="">
            ...
            <input type="number" name="sdt" min="1" required><br><br>
            <label>Địa chỉ:</label>
            <input type="text" name="diachi" required><br><br>
            <br><button type="submit">Lưu khách hàng</button>
        </form>
