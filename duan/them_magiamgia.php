...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $ma = $_POST['ma'];
    $giam = $_POST['phanTramGiam'];
    $han = $_POST['hanSuDung'];

    $db_util->execute("INSERT INTO magiamgia (ma, phanTramGiam, hanSuDung) VALUES (?, ?, ?)", [$ma, $giam, $han]);
...
<body>
    ...
    <div class="form-container">
        ...
        <form method="post">
            ...
            <input type="number" name="phanTramGiam" min="1" max="100" required><br><br>

            <label>Hạn sử dụng:</label><br>
            <input type="date" name="hanSuDung" required><br><br>
