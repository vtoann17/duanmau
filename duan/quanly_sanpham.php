...
<?php endif; ?>
      ...
      <thead>
        <tr>
          <th>ID</th><th>Tên</th><th>Miêu tả</th><th>Giá</th><th>Ảnh</th><th>Loại</th><th>Hành động</th>
        </tr>
      </thead>
      <tbody>
        <?php foreach ($sanphams as $sp): ?>
          <?php
            $variants = $db_util->getAll("SELECT * FROM bienthesanpham WHERE sanPhamID = ?", [$sp['id']]);
